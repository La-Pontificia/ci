...
function User({ user: userInit }: { user: Type }) {
  ...
  return (
    <div className="flex items-start p-2 gap-3">
      ...
      <div className="border-b dark:border-lime-100/20 pb-4 border-neutral-300 w-full flex items-center">
        <div className="flex flex-col gap-1 text-zinc-800 dark:text-neutral-50 text-sm tracking-tight font-medium">
          <span className="text-base font-semibold">{user.names}</span>
          <div className="flex gap-3 divide-x divide-neutral-700">
            <span className="lowercase text-neutral-600 dark:text-neutral-400">
              {user.email}
            </span>
