...
function Chairs({ table }: Props) {
  ...
  return (
    <>
      {table.type === 'pc' && (
        <span className="absolute inset-1 pointer-events-none border-current rounded-full border-[12px]" />
      )}
      <span
        className={cn(
          className,
          'w-full top-1 pointer-events-none left-0',
          className2,
          isFor && 'px-6'
        )}
      >
      ...
      <span
        className={cn(
          className,
          'flex-col pointer-events-none h-full py-6 top-0 left-1',
          className2
        )}
      >
        {chairs[1].map((_, i) => (
      ...
      <span
        className={cn(
          className,
          'flex-col pointer-events-none h-full py-6 top-0 right-1',
          className2
        )}
      >
        {chairs[2].map((_, i) => (
      ...
      <span
        className={cn(
          className,
          'gap-1 px-1 pointer-events-none w-full bottom-1 left-0',
          className2,
          isFor && 'px-6'
        )}
      >
